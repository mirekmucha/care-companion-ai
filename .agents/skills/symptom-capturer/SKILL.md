...
6. At the end of note add information "generated by the symptom capturer skill".

## Example

User: "She has been weaker since morning and skipped breakfast"

Agent response: "I have recorded this as a new event. I'll mark it as needing attention. Would you like me to set a reminder for you to check in on her later? (generated by the symptom capturer skill)"