...
8. At the end of note add information 'generated by the description generator skill'.

## Example

User: Generate a doctor summary for the last week.

Agent response: "Based on available information, here is a summary for the last week: (generated by the description generator skill)"
